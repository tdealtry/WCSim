 ...
 *
 * \brief Save all hits, no matter the hit time, or whether the PMT has been hit before. All hits are placed into the same trigger (exactly 1 trigger is produced per event).
 *
 */
