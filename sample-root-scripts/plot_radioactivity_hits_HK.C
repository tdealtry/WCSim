...
int main(){
  ...
  //TString RadioactivityDirec = Form("outputs/radioactivity_BiPmt1event/");
  //TString RadioactivityDirec = Form("outputs/radioactivity_KPmt1event/");
 ...
 TString Isotope = Form("Rn220");
  ...
  TString OutputFile = Form("radioactivity_hits_HK_")+Isotope+Form("Pmt1event.root");

  TFile output(OutputFile.Data(),"RECREATE");
  ...
  TH1F *h_Radioactivity_charge_hit = new TH1F("h_Radioactivity_charge_hit","radioactivity",250,-0.5,249.5);
  ...
  TH1F *h_Radioactivity_charge_max_hit = new TH1F("h_Radioactivity_charge_max_hit","radioactivity",250,-0.5,249.5);
  ...
  TH1F *h_Radioactivity_charge_all_hits = new TH1F("h_Radioactivity_charge_all_hits","radioactivity",250,-0.5,249.5);
  h_Radioactivity_charge_all_hits->SetLineColor(kRed);
  ...
  for(int ievent=0; ievent<Radioactivity_primary_events_tree->GetEntries(); ievent++){
    std::clog << " ievent " << ievent << " of " << Radioactivity_primary_events_tree->GetEntries() << std::endl;
  ...
  // h_Electrons_charge_hit->GetXaxis()->SetTitle("charge per hit [p.e.]");
  ...
  // h_Electrons_charge_max_hit->GetXaxis()->SetTitle("charge of hit with maximum charge [p.e.]");
  // TH1F *h_Electrons_charge_all_hits = new TH1F("h_Electrons_charge_all_hits","3 MeV electrons",38,0,76);
  // h_Electrons_charge_all_hits->SetLineColor(kBlue);
  // h_Electrons_charge_all_hits->SetLineStyle(1);
  // h_Electrons_charge_all_hits->SetLineWidth(2);
  // h_Electrons_charge_all_hits->GetXaxis()->SetTitle("charge of all hits in the event [p.e.]");
  // for(int ievent=0; ievent<Electrons_primary_events_tree->GetEntries(); ievent++){
  //   std::clog << " ievent " << ievent << " of " << Electrons_primary_events_tree->GetEntries() << std::endl;
  ...
  //     h_Electrons_charge_all_hits->Fill(totQ);
  //   }
  // }
  ...
  // h_Electrons_charge_all_hits->Scale(1./h_Electrons_charge_all_hits->Integral());
  ...
  // h_Electrons_charge_all_hits->Write();
