...
# geometry
parser.add_argument('--WCgeom', type=delim_list, default='HyperK', help='The water tank geometry. Specify multiple with comma separated list. Choices: '+ListAsString(WCgeom_choices))
...
parser.add_argument('--DAQndigitswindow', type=delim_list, default='400', help='What value of the ndigits trigger window should be used (ns)? Specify multiple with comma separated list')
...
parser.add_argument('--DAQndigitssavewindow', type=delim_list, default='-400:+1600', help='What value of the pre/post trigger window should digits be saved in (for the ndigits trigger)? Separate pre/post with a ":". Specify multiple pairs with a comma separated list')
...
parser.add_argument('--DAQsavefailuressavewindow', type=delim_list, default='-400:+1600', help='What value of the pre/post trigger window should digits be saved in (for the save failures)? Separate pre/post with a ":". Specify multiple pairs with a comma separated list')
#dark noise
parser.add_argument('--DarkNoiseRate', type=delim_list, default='8.4', help='Dark noise rate (kHz). Specify multiple with comma separated list')
parser.add_argument('--DarkNoiseConvert', type=delim_list, default='1.126', help='Convert dark noise frequency before digitization to after digitization by setting suitable factor. Specify multiple with comma separated list')
...
#dark noise
parser.add_argument('--ODDarkNoiseRate', type=delim_list, default='0.4', help='Dark noise rate (kHz). Specify multiple with comma separated list')
